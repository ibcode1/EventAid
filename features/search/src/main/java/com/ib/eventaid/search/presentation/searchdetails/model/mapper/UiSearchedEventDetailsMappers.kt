package com.ib.eventaid.search.presentation.searchdetails.model.mapper
...
class UiSearchedEventDetailsMappers @Inject constructor() : UiMapper<EventWithDetails, UISearchedEventDetailed> {
    override fun mapToView(input: EventWithDetails): UISearchedEventDetailed {
        return UISearchedEventDetailed(
            id = input.id,
            title = input.title,
